...
const AdminCampsites = () => {
    ...
    return (
        <div style={{ fontSize: "18px", color: "#000", padding: "0px 10px", background: "#fff" }}>
            ...
            <table style={{ width: "100%", borderCollapse: "separate", borderSpacing: "0px", borderRadius: "10px", overflow: "visible", textAlign: "center", border: "1px solid #ccc" }}>
                <thead>
                ...
                <tbody>
                    {campsites.map((campsite, index) => (
                        <tr key={campsite._id}>
                            ...
                            <td>₹{campsite.price.toFixed(2)}</td>
                            <td><img src={Array.isArray(campsite.imageUrl) ? campsite.imageUrl[0] : campsite.imageUrl} alt={campsite.name} style={{ width: "100px", height: "auto" }} /></td>
                            <td>{Array.isArray(campsite.feature) ? campsite.feature.join(", ") : campsite.feature}</td>
                            <td>{Array.isArray(campsite.amenities) ? campsite.amenities.join(", ") : campsite.amenities}</td>
                            ...
                            <td><Pencil onClick={() => setEditingCampsite(campsite)} color="#fff" fill="#2d6a4f" size={20} strokeWidth={1.25} style={{ cursor: "pointer" }} /></td>
                            <td><Trash2 onClick={() => handleDeleteCampsite(campsite._id)} color="#b21807" size={20} strokeWidth={1.25} style={{ cursor: "pointer" }} /></td>
                        </tr>
                    ))}
                </tbody>
            </table>
